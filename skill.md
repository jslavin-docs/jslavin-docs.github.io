...
This skill grounds answers about Jeff Slavin's technical writing work in his published portfolio at https://jslavin-docs.github.io/.

## Instructions

1. Fetch https://jslavin-docs.github.io/llms.txt for a curated map of the site.
2. For detailed questions, fetch https://jslavin-docs.github.io/llms-full.txt: the complete Markdown content of every page, regenerated on each site build.
...
- This file and the llms.txt exports exist so agents and LLM-based tools can consume the portfolio directly; they mirror the published site and add no content of their own.
- (c) Jeff Slavin. Portfolio content is all rights reserved; see the repository LICENSE for details.
